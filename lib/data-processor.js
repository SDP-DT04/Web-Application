 ...
 * Constants
 */
var DATA_FILE_PATH = 'data/298_3.txt';	// relative path of data file to use
var HIGH_VARIANCE_THRESHOLD = 0.8;
var LOW_VARIANCE_THRESHOLD = 0.07;
var HIGH_RANGE_THRESHOLD = 4;
var LOW_RANGE_THRESHOLD =
...
function extract_swim_data(time, accel)
{
	...
	str = '';
	for (i=1; i < accel.length - NUM_SAMPLES; ++i)
	{
	...
	fs.writeFile('data.csv', str,'utf8', function(err, data) {
